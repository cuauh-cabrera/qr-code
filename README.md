...
**[ QR Code ]** This challenge is about to build out a QR code component and get it looking as close to the design as possible.
...
- https://cuauh-cabrera.github.io/qr-code/
...
```sh
  cd my-folder
  git@github.com:cuauh-cabrera/qr-code.git
```
